...
class QuestionPanel(private val createPage: CreatePage) : Component() {
    ...
    private enum class QType(val type: String, val subtype: String) {
        ...
        FREEFORM_MULTIPLE_ANSWER(QuestionType.FREEFORM, FreeformSubtype.MULTI),
        ...
        override fun toString(): String {
            return name.split('_').joinToString(separator = " ") { it.lowercase().replaceFirstChar { c -> c.uppercaseChar() } }
        }
    }
}
